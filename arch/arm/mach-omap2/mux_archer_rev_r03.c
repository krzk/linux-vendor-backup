...
//	{ GPIO NUMBER      , DEFAULT VALUE }
	...
	{ OMAP_GPIO_AP_I2C_SCL,		1}, //40
	{ OMAP_GPIO_AP_I2C_SDA, 		1}, //41
	...
	{ OMAP_GPIO_EAR_MICBIAS_EN,	0 },	// 102
 ...
 */
	...
	// 45 (N3, H, SAFE_MODE, N/C) OMAP_GPIO_AP_I2C_SCL
	MUX_CFG_34XX("N3_GPMC_A7", 0x0086,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP)
	// 46 (M3, H, SAFE_MODE, N/C) OMAP_GPIO_AP_I2C_SDA
	MUX_CFG_34XX("M3_GPMC_A8", 0x0088,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP)
	...
	MUX_CFG_34XX("R8_GPMC_NCS5", 0x00B8,  OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_INPUT_PULLDOWN | OMAP34XX_PIN_OFF_OUTPUT_LOW)
	...
	// 83 (J8, H, GPIO_65, KEY_HOME, O[L], OFF[L])
	MUX_CFG_34XX("J8_GPMC_WAIT3", 0x00D2,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP)
	...
	// 120 (C24, L, GPIO_102, MICBIAS_EN, N/C)
	...
	MUX_CFG_34XX("AE6_MCBSP3_DR", 0x016E,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
	...
	MUX_CFG_34XX("AE5_MCBSP3_FSX", 0x0172,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_HIGH)
	...
	// 169 (AA9, L, GPIO_149, O[H], OFF[H])
	MUX_CFG_34XX("AA9_UART1_RTS", 0x017E,  OMAP34XX_MUX_MODE7)
	...
	// 214 (Y2, L, GPIO_179, SAFE_MODE, N/C)
	MUX_CFG_34XX("Y2_MCSPI2_SIMO", 0x01D8,  OMAP34XX_MUX_MODE7)
