...
#if defined(CONFIG_CHN_CAM_S5K4ECGX)
#include "../../../drivers/media/video/s5k4ecgx.h"
struct s5k4ecgx_platform_data zeus_s5k4ecgx_platform_data;
#endif  // CONFIG_CHN_CAM_S5K4ECGX
...
static struct gpio_switch_platform_data headset_switch_data = {
	.name = "h2w",
	.gpio = OMAP_GPIO_JACK_NINT,	/* Omap3430 GPIO_27 For samsung zeus */
};
...
static struct resource onedram_res[] = {
	[ 0 ] = {
		.start = ( 0xA0000000 + 0x05000000 ), // Physical memory address
		.end = ( 0xA0000000 + 0x05000000 + 0x1000000 - 1 ),
		.flags = IORESOURCE_MEM,
	},
	[ 1 ] = {
		.start = OMAP_GPIO_IRQ( 15 ), // Irq - Onedram Mailbox Int
		.end = OMAP_GPIO_IRQ( 15 ),
...
static void modemctl_cfg_gpio( void )
{
	...
	if( err ) {
		...
		gpio_direction_output( gpio_con_cp_sel, 1 );
	}
...
#if defined( CONFIG_CHN_KERNEL_STE_LATONA ) //CMMB
static struct omap2_mcspi_device_config board_cmmb_spi_mcspi_config = {
	.turbo_mode     =   0,
	.single_channel =   1,
};	//for CMMB_SPI
#endif
...
static struct spi_board_info board_spi_board_info[] __initdata = {
	...
	[ 1 ] = {
		...
		.controller_data = &board_cmmb_spi_mcspi_config,
	}, //for CMMB_SPI
#else
	[ 2 ] = {
		.modalias = "smsspi",
...
static struct i2c_board_info __initdata board_i2c_boardinfo1[] = {
...
#if defined(CONFIG_CHN_CAM_S5K4ECGX)
	{
		I2C_BOARD_INFO(S5K4ECGX_DRIVER_NAME, S5K4ECGX_I2C_ADDR),
		.platform_data = &zeus_s5k4ecgx_platform_data,
	},
#endif  // CONFIG_CHN_CAM_S5K4ECGX
#if defined(CONFIG_CHN_CAM_SR030PC40)
	{
...
#endif  // CONFIG_VIDEO_CAM_PMIC
	{
		...
		.flags = I2C_CLIENT_WAKE,
		.irq = OMAP_GPIO_IRQ(OMAP_GPIO_LOW_BAT_DET),
	},
...
#endif
#if !defined(CONFIG_INPUT_YAS_MAGNETOMETER_USE_GPIO_I2C)
	{
...
{
	board_ear_key_resource.start = gpio_to_irq(OMAP_GPIO_EAR_KEY);
...
{
	int ret = 0;
#if 0 // for build latona td hw rev0.4
...
// For Regulator Framework 
    ...
    board_usb_data.sensor_dev = &samsung_pl_sensor_power_device.dev;    // Add for regulator
