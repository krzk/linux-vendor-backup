 ...
 */
	...
	// 39 (H4, L, GPMC_A1, INT_TEMP_POP) // 09/18
	OMAP3_MUX(GPMC_A1, OMAP34XX_MUX_MODE7),
	// 40 (G2, L, GPIO_35, GPS_EN) // 09/18
	...
	OMAP3_MUX(GPMC_A4, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT),
	// 43 (F3, L, GPIO_38, SENSOR_SDA, O[H], OFF[H]) // 09/18
	OMAP3_MUX(GPMC_A5, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT),
	// 44 (E2, H, GPIO_39, GPS_nRST, I[?], OFF[?]) // 09/18
	OMAP3_MUX(GPMC_A6,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),

	// 45 (E3, H, GPIO_40, OMAP_GPIO_AP_I2C_SCL, I[H], I[H]) // 09/16 changoh.heo
	OMAP3_MUX(GPMC_A7,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
	// 46 (E4, H, GPIO_41, OMAP_GPIO_AP_I2C_SDA, I[H], I[H]) // 09/16 changoh.heo
	...
	// 117 (AF16, L, SAFE_MODE, N/C) - 09/17
	...
	OMAP3_MUX(SDMMC1_DAT4,  OMAP34XX_MUX_MODE7),	// Brian: NC
	...
	// 148 (R27, L, GPIO_128, ALS_SDA, O[H], OFF[H])
	OMAP3_MUX(SDMMC1_DAT6,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
	// 149 (R25, L, GPIO_129, ALS_SCL, O[H], OFF[H])
	OMAP3_MUX(SDMMC1_DAT7,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
...
//	OMAP3_MUX(SDMMC2_DAT4,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT ),
	...
	OMAP3_MUX(UART1_TX,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP),
	...
	OMAP3_MUX(UART1_RX,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP),
	...
	OMAP3_MUX(MCBSP4_DX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
	...
	// 178 (N18, L, SAFE_MODE, N/C) - 09/17
	OMAP3_MUX(MCBSP1_DX,  OMAP34XX_MUX_MODE7),		// Brian: NC
	...
	// 181 (K26, L, GPIO_161, I2S_SYNC2, I/O)
	...
	// 212 (J9, H, SAFE_MODE, N/C) - 09/17
	OMAP3_MUX(MCSPI1_CS3, OMAP34XX_MUX_MODE7),
	...
	// 318 (AC5, L, GPIO_27, DET_3.5, I[U], OFF[U]) // 09/16 changoh.heo
