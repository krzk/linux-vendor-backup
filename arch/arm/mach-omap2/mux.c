...
#include "mux_latona_ste_rev_r01.c"
#elif ( defined( CONFIG_MACH_SAMSUNG_LATONA ) && defined(CONFIG_CHN_KERNEL_STE_LATONA) && \
      ( CONFIG_SAMSUNG_REL_HW_REV == 2 ) )
#include "mux_latona_ste_rev_r02.c"
#elif ( defined( CONFIG_MACH_SAMSUNG_LATONA ) && defined(CONFIG_CHN_KERNEL_STE_LATONA) && \
      ( CONFIG_SAMSUNG_REL_HW_REV == 4 ) )
#include "mux_latona_ste_rev_r04.c"
#elif ( defined( CONFIG_MACH_SAMSUNG_LATONA ) && \
    ( CONFIG_SAMSUNG_EMU_HW_REV == 0 ) )
#include "mux_latona_rev_e00.c"
#elif ( defined( CONFIG_MACH_SAMSUNG_LATONA ) && \
      ( CONFIG_SAMSUNG_REL_HW_REV == 0 ) )
#include "mux_latona_rev_r00.c"
#elif ( defined( CONFIG_MACH_SAMSUNG_LATONA ) && \
      ( CONFIG_SAMSUNG_REL_HW_REV == 1 ) )
#include "mux_latona_rev_r01.c"
#elif ( defined( CONFIG_MACH_SAMSUNG_LATONA ) && \
      ( CONFIG_SAMSUNG_REL_HW_REV == 2 ) )
#include "mux_latona_rev_r02.c"
#elif ( defined( CONFIG_MACH_SAMSUNG_LATONA ) && \
      ( CONFIG_SAMSUNG_REL_HW_REV == 8 ) )
#include "mux_latona_rev_r08.c"
#elif ( defined( CONFIG_MACH_SAMSUNG_HERON ) && \
      ( CONFIG_SAMSUNG_REL_HW_REV == 1 ) )
#include "mux_heron_rev_r01.c"
#endif
...
static void __init omap_mux_set_board_signals(struct omap_board_mux *board_mux)
{
    ...
    /* remov debug code */
		/* printk(KERN_WARNING "MUX: setup (0x%p): 0x%04x\n",
			omap_ctrl_base_get() + board_mux->reg_offset, board_mux->value); */
...
#if 1 // kmj_DC06.mux_cfg_for_touch_I2C
void change_pins_of_touch_at_suspend(void)
{
	omap_ctrl_writew(OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW, 0x01C2);
	omap_ctrl_writew(OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW, 0x01C4);
}

void change_pins_of_touch_at_resume(void)
{
	omap_ctrl_writew(OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_OUTPUT_LOW, 0x01C2);
	omap_ctrl_writew(OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_OUTPUT_LOW, 0x01C4);
}
#endif
