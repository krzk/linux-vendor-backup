...
#if 1//TI HS.Yoon 20110124 for TP enhancement
u8 prevent_cpu_idle_by_wifi = 0;
EXPORT_SYMBOL(prevent_cpu_idle_by_wifi);
#endif
static int omap3_idle_bm_check(void)
{
#if 1//TI HS.Yoon 20110124 for TP enhancement
	if (!omap3_can_sleep() || prevent_cpu_idle_by_wifi)
#else
	if (!omap3_can_sleep())
#endif
		return 1;
