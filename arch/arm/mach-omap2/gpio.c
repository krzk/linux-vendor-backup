...
/* Todo :this code need to be platform independent. */

	if(gpio == OMAP_GPIO_JACK_NINT)
...
static int __devinit omap_gpio_probe(struct platform_device *pdev)
{
	...
	}
	{
		...
		#if 1 //TI Lewis.Byun 20101020 : it's blocked wakeup pin setting. it's not applicable for the Eve project
