...
//  { GPIO NUMBER      , DEFAULT VALUE }
	...
	{ OMAP_GPIO_FM_nRST		        , 0 },  // 09/16 gatz92jeon
    { OMAP_GPIO_CAM_VGA_NRST        , 0 },
    { OMAP_GPIO_CAM_VGA_NSTBY       , 0 },	
	{ OMAP_GPIO_CAM_3M_NSTBY        , 0 },
...
//    { OMAP_GPIO_UART_SEL            , 0 },
	...
	{ OMAP_GPIO_USBSW_I2C_SDA				, 0 },
	{ OMAP_GPIO_LED_EN2				, 0 },
	{ OMAP_GPIO_CP_RST				, 0 },
	{ OMAP_GPIO_IPC_MRDY			, 0 },
	{ OMAP_GPIO_PDA_ACTIVE			, 0 },
	{ OMAP_GPIO_PCM_SEL				, 0 },
//	{ OMAP_GPIO_EARPATH_SEL			, 0 },		// Heekwon Ko
	{ OMAP_GPIO_EN_TEMP_VDD			, 0 },
	{ OMAP_GPIO_KEY_LED_EN			, 0 },
    ...
    { OMAP_GPIO_FM_SCL          , 1 },
    { OMAP_GPIO_FM_SDA          , 1 }, 
//	{ OMAP_GPIO_MASSMEMORY_EN	    , 1 },
    { OMAP_GPIO_FUEL_SDA            , 1 },
    { OMAP_GPIO_FUEL_SCL            , 1 },
//    { OMAP_GPIO_ALS_EN              , 0 },
    { OMAP_GPIO_PCM_SEL				, 0 },
//	{ OMAP_GPIO_EARPATH_SEL			, 0 },		// Heekwon Ko	
	{ OMAP_GPIO_CON_CP_SEL			, 0 },	
...
#if defined (CONFIG_MACH_SAMSUNG_LATONA) || defined (CONFIG_MACH_SAMSUNG_HERON)
 ...
 */
	...
	OMAP3_MUX(GPMC_A7,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	...
	OMAP3_MUX(GPMC_A9,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT ),
	...
	OMAP3_MUX(GPMC_NCS5,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),				// CP_DOWNLOAD
	...
	// 77 (G3, L, GPIO_60, GPMC_NBE0_CLE, KEY_LED_EN, O[L], OFF[L])
	OMAP3_MUX(GPMC_NBE0_CLE,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),
	// 78 (U3, L, GPMC_NBE1, AMP_I2C_SCL, O)                                //hyosun86.lee
	OMAP3_MUX(GPMC_NBE1,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP), 						
	// 79 (H1, L, GPMC_NWP, AMP_I2C_SDA, O)                                ////hyosun86.lee
	OMAP3_MUX(GPMC_NWP,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP), 
	// 80 
	...
	OMAP3_MUX(GPMC_WAIT3,   OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP | OMAP3_WAKEUP_EN),	// HOME_KEY
	...
	// 118 (AF15, L, GPIO_100, VGH_DETECT, I[L], OFF[L])
	OMAP3_MUX(CAM_D1, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
	...
	OMAP3_MUX(SDMMC2_CLK,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),   //chaehoon.kim NC
	...
	OMAP3_MUX(SDMMC2_CMD,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	 //chaehoon.kim NC

	// 152 (AH5, H, SAFE_MODE, MMC2_DAT0, MOVI_DAT0, N/C)
	OMAP3_MUX(SDMMC2_DAT0,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	//chaehoon.kim NC
	// 153 (AH4, H, SAFE_MODE, MMC2_DAT1, MOVI_DAT1, N/C)
	OMAP3_MUX(SDMMC2_DAT1,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	//chaehoon.kim NC
	// 154 (AG4, H, SAFE_MODE, MMC2_DAT2, MOVI_DAT2, N/C)
	OMAP3_MUX(SDMMC2_DAT2,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	//chaehoon.kim NC
	// 155 (AF4, H, SAFE_MODE, MMC2_DAT3, MOVI_DAT3, N/C)
	OMAP3_MUX(SDMMC2_DAT3,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	//chaehoon.kim NC
	// 156 (AE4, H, SAFE_MODE, MMC2_DAT4, O[H], OFF[H])
	OMAP3_MUX(SDMMC2_DAT4,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),  //chaehoon.kim NC
	// 157 (AH3, H, SAFE_MODE, MMC2_DAT5, O[H], OFF[H])
	OMAP3_MUX(SDMMC2_DAT5,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),  //chaehoon.kim NC

	// 158 (AF3, GPIO_138, SENSOR_SCL, O[L], OFF[L])
	OMAP3_MUX(SDMMC2_DAT6, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),
	// 159 (AE3, GPIO_139, SENSOR_SDA, O[L], OFF[L])
	OMAP3_MUX(SDMMC2_DAT7, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),
	...
	// 172 (AE1, L, GPIO_152, CAM_EN1, O[L], OFF[L])
	OMAP3_MUX(MCBSP4_CLKX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 173 (AD1, L, GPIO_153, CAM_3M_nSTBY, N/C)
	...
	// 178 (N18, L, GPIO_158, OMAP_GPIO_USBSW_I2C_SDA, O[L])
	//OMAP3_MUX(MCBSP1_DX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),
	OMAP3_MUX(MCBSP1_DX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),	// USBSW_I2C_SDA, temporarily MUX_MODE7
	// 179 (U21, L, GPIO_159 CP_JIG_ON , I2S_DIN2, I)
	//OMAP3_MUX(MCBSP1_DR,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),
	OMAP3_MUX(MCBSP1_DR,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),	// CP_JIG_ON, temporarily MUX_MODE7
	...
	//OMAP3_MUX(MCBSP1_FSX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),		// Brian: NC
	OMAP3_MUX(MCBSP1_FSX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),	// USBSW_I2C_SCL,	temporarily MUX_MODE7
	// 182 (W21, H, GOIO_162, OMAP_GPIO_LED_EN2, O[L])
	//OMAP3_MUX(MCBSP1_CLKX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),
	OMAP3_MUX(MCBSP1_CLKX,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_OUTPUT),	// CMMB_PWR_EN,	temporarily MUX_MODE7
	...
	// 201 (AF15, H, I2C2_SCL, CAMERA_I2C_SCL, I/O)
	OMAP3_MUX(I2C2_SCL,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP),
	// 202 (AE15, H, I2C2_SDA, CAMERA_I2C_SDA, I/O)
	...
	// GPIO_186 (AE22,  , GPIO_186, CAM_EN2, O)
	...
	OMAP3_MUX(ETK_D1,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
	...
	OMAP3_MUX(ETK_D7,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_OUTPUT),										//	NC
