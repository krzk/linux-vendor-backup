...
//	{ OMAP_GPIO_CON_CP_SEL			, 1 },
	{ OMAP_GPIO_PHONE_ON			, 0 },
	{ OMAP_GPIO_MSENSE_NRST 		, 0 },
	/* i2c emulation pins (end) */
	{ OMAP_GPIO_CMMB_PWR_EN			, 0 },
	{ OMAP_GPIO_CMMB_RST			, 0 },
};

unsigned int wakeup_gpio[] = {
	OMAP_GPIO_USBSW_NINT,
	OMAP_GPIO_LOW_BAT_DET,
	OMAP_GPIO_JACK_NINT,
 ...
 */
	...
	// 40 (M4, L, GPIO_35, AP_AGPS_ONOFF, O[L], OFF[L])
	OMAP3_MUX(GPMC_A2, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),
	// 41 (G3, L, GPIO_36, AP_AGPS_RESETn, O[L], OFF[L]) // 09/18
	OMAP3_MUX(GPMC_A3, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT), 	// AP_AGPS_RESETn
	...
	// 44 (E2, H, GPIO_39, AP_AGPS_TSYNC, I[L], OFF[L]) // 09/18
	OMAP3_MUX(GPMC_A6, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),

	// 45 (E3, H, GPIO_40, CMMB_PWR_EN, O[H], OFF[L]) // 2011.01.26 for IF228
	OMAP3_MUX(GPMC_A7,	OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_INPUT_PULLDOWN ),
	// 46 (E4, H, GPIO_41, CMMB_RST, O[H], OFF[L]) // 2011.01.26 for IF228
	OMAP3_MUX(GPMC_A8,	OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_INPUT_PULLDOWN ),
	// 47 (L3, H, GPIO_42, CMMB_INT ) // 2011.01.26 for IF228
	OMAP3_MUX(GPMC_A9,	OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT ),
	...
	// 66 (C2, H, GPIO_52, SAFE_MODE, NC)
	OMAP3_MUX(GPMC_NCS1,  OMAP34XX_MUX_MODE7| OMAP34XX_PIN_INPUT_PULLDOWN),
	// 67 (V8, H, GPIO_53, PS_OUT, I[H], OFF[H]) 
	OMAP3_MUX(GPMC_NCS2, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP ),
	// 68 (U8, H, GPIO_54, IF_CON_SENSE18, I[L], OFF[L])
	OMAP3_MUX(GPMC_NCS3,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT), //egkim
	// 69 (B3, H, GPIO_55, SAFE_MODE, NC)
	OMAP3_MUX(GPMC_NCS4,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 70 (R8, H, GPIO_56, SAFE_MODE, NC)
	OMAP3_MUX(GPMC_NCS5,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),		// Brian: when off, INPUT_PULLDOWN duplicated
	// 71 (P8, H, GPIO_57, USBSW_BOOT, I[L])
	OMAP3_MUX(GPMC_NCS6,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN), 
	...
	// 77 (G3, L, GPIO_60, OMAP_GPIO_LED_EN2, O[L])
	OMAP3_MUX(GPMC_NBE0_CLE,   OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 78 (U3, L, GPIO_61,  LCD_ID2, O[H], OFF[H])                 
	OMAP3_MUX(GPMC_NBE1, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT), 						
	// 79 (H1, L, GPIO_62 , LCD_ID1, O)                             
	OMAP3_MUX(GPMC_NWP,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT), 
	// 80 
	...
	// 82 (K8, H, GPIO_64, CAM_VGA_nRST, O[L], OFF[L])
	OMAP3_MUX(GPMC_WAIT2,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 83 (J8, H, GPIO_65, KEY_HOME, I[H], OFF[H] )
	OMAP3_MUX(GPMC_WAIT3,	OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP3_WAKEUP_EN),
	...
	// 112 (A24, L, CAM_HS, PIXEL_HSYNC, GPIO_94, O)
	OMAP3_MUX(CAM_HS,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 113 (A23, L, CAM_VS, PIXEL_VSYNC, GPIO_95, O)
	OMAP3_MUX(CAM_VS,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 114 (C25, L, CAM_XLCKA, PIXEL_MCLK, GPIO_96, O)
	OMAP3_MUX(CAM_XCLKA,  OMAP34XX_MUX_MODE0),
	// 115 (C27, L, CAM_PCLK, PIXEL_PCLK, GPIO_97, O)
	OMAP3_MUX(CAM_PCLK,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN),

	// 116 (C23, L, GPIO_98, CAM_5M_nRST, O[L], OFF[L])
	OMAP3_MUX(CAM_FLD,	OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 117 (AF16, L, GPIO_99, SAFE_MODE, NC) 
	OMAP3_MUX(CAM_D0, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 118 (AF15, L, GPIO_100, SAFE_MODE, N/C) - 09/17
	OMAP3_MUX(CAM_D1, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN), 
	// 119 (B24, L, GPIO_101, CAM_VGA_nSTBY, O[L], OFF[L])
	...
	// 130 (B20, L, GPIO_167, SAFE_MODE, N/C) 
	OMAP3_MUX(CAM_WEN, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 131 (D25, L, GPIO_126, UART_SEL, O[L], OFF[L])
	OMAP3_MUX(CAM_STROBE,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 132 (AF18, L, GPIO_112, GPIO_VF, O[L])
	OMAP3_MUX(CSI2_DX0,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
	// 133 (AF17, L, GPIO_113, SAFE_MODE, NC)
	OMAP3_MUX(CSI2_DY0,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 134 (AG18, L, GPIO_114, ACC_INT2, I[L], OFF[L])
	OMAP3_MUX(CSI2_DX1,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 135 (AH18, L, GPIO_115, ACC_INT1, I[L], OFF[L])
	...
	OMAP3_MUX(SDMMC1_CLK,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_INPUT_PULLDOWN),
	...
	// 146 (K23, L, GPIO_126, SAFE_MODE, N/C) - 09/17
	...
	// 149 (R25, L, GPIO_129, SAFE_MODE, N/C)
	OMAP3_MUX(SDMMC1_DAT7,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),

	// 150 (AE2, L, GPIO_130, SAFE_MODE, N/C)
	OMAP3_MUX(SDMMC2_CLK,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	
	// 151 (AG5, H, GPIO_131, SAFE_MODE, N/C)
	OMAP3_MUX(SDMMC2_CMD,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	

	// 152 (AH5, H, GPIO_132, SAFE_MODE, N/C)
	OMAP3_MUX(SDMMC2_DAT0,	OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	
	// 153 (AH4, H, GPIO_133, SAFE_MODE, N/C)
	OMAP3_MUX(SDMMC2_DAT1,	OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	
	// 154 (AG4, H, GPIO_134, SAFE_MODE, N/C)
	OMAP3_MUX(SDMMC2_DAT2,	OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	
	// 155 (AF4, H, GPIO_135, SAFE_MODE, N/C)
	OMAP3_MUX(SDMMC2_DAT3,	OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	
	// 156 (AE4, L, GPIO_136, FUEL_SDA, O[H], OFF[H])
	OMAP3_MUX(SDMMC2_DAT4,	OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_INPUT_PULLUP ),
	// 157 (AH3, H, GPIO_137, FUEL_SDA, O)
	OMAP3_MUX(SDMMC2_DAT5,	OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_INPUT_PULLUP ),

	// 158 (AF3, GPIO_138,    SAFE_MODE, N/C)
	OMAP3_MUX(SDMMC2_DAT6, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 159 (AE3, GPIO_139, GPS_EN, O[L], OFF[L])
	OMAP3_MUX(SDMMC2_DAT7, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),	// GPS_EN
	...
	// 169 (AA9, GPIO_149, CON_CP_BOOT, O[L], OFF[L]) //jongmoon.suh
	OMAP3_MUX(UART1_RTS, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
	// 170 (W8, L, GPIO_150, AMP_SHDN, O[L], OFF[L])
	OMAP3_MUX(UART1_CTS, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT),
	...
	// 172 (P8, L, GPIO_152, CAM_EN2, O[L], OFF[L])
	OMAP3_MUX(MCBSP4_CLKX,	OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 173 (AD1, L, GPIO_153, CAM_5M_nSTBY, O[L])
	OMAP3_MUX(MCBSP4_DR,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 174 (AD2, L, GPIO_154, PHONE_ACTIVE) // 11/30 jongmoon.suh
	OMAP3_MUX(MCBSP4_DX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT), // | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 175 (M8, L, GPIO_155, SAFE_MODE, N/C)
	OMAP3_MUX(MCBSP4_FSX,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),
	...
	// 176 (P18, L, GPIO_156, CAM_EN1, O[L], OFF[L])
	OMAP3_MUX(MCBSP1_CLKR,	OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 177 (AA21, L, GPIO_157, CAM_EN5, O[L], OFF[L])
	OMAP3_MUX(MCBSP1_FSR, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 178 (N18, L, GPIO_158, SAFE_MODE, OMAP_GPIO_LED_EN1)
	OMAP3_MUX(MCBSP1_DX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	...
	// 181 (K26, L, GPIO_161, CHG_EN, N/C)
	OMAP3_MUX(MCBSP1_FSX,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_OUTPUT),
	// 182 (W21, H, GPIO_162, SAFE_MODE, N/C)
	OMAP3_MUX(MCBSP1_CLKX,	OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN), //CMMB PWR_EN
	...
	// 201 (AF15, H, I2C2_SCL, AP_SCL, GPIO_168, I/O)
	OMAP3_MUX(I2C2_SCL,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP),
	// 202 (AE15, H, I2C2_SDA, AP_SDA, GPIO_183, I/O)
	...
	// 212 (AB2, H, GPIO_177, CAM_EN4, O[L]) 
	OMAP3_MUX(MCSPI1_CS3, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),

	// 213 (H9, L, GPIO_178, CMMB_SPI_CLK, 0) // 2011.01.26 for IF228
	OMAP3_MUX(MCSPI2_CLK,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 214 (J10, L, GPIO_179, CMMB_SPI_MOSI, 0) // 2011.01.26 for IF228 
	OMAP3_MUX(MCSPI2_SIMO,	OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT), 
	// 215 (H10, L, GPIO_180, CMMB_SPI_MISO, 0) // 2011.01.26 for IF228 
	OMAP3_MUX(MCSPI2_SOMI,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP),
	// 216 (H11, H, GPIO_181, CMMB_CS_LOAD, 0) // 2011.01.26 for IF228 
	OMAP3_MUX(MCSPI2_CS0,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT),      

	// 217 (J11, L, GPIO_182, NC, 0) 
	...
	// NEW (AC10, L, GPIO_186, CAM_EN3, O[L], OFF[L])
	OMAP3_MUX(SYS_CLKOUT2, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	...
	// 296 (AG25, L, GPIO_10, OMAP_GPIO_USBSW_NINT, I[H], OFF[H])
	...
	// 305 (AF11, H, GPIO_14,  OMAP_GPIO_ALARM_AP, I[H])
	OMAP3_MUX(ETK_D0,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT), //_PULLDOWN),	
	// 306 (AG12, H, GPIO_15, INT_ONEDRAM_AP, I[H], OFF[H])
	OMAP3_MUX(ETK_D1,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP | OMAP3_WAKEUP_EN),
	// 307 (AH12, H, GPIO_16, SAFE_MODE, NC)
	OMAP3_MUX(ETK_D2,  OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN), //EXTERNAL PULL-UP
	...
	// 312 (AH14, L, GPIO_21, WL_INT, I[L],// OFF[L])
	...
	// 316 (AF7, L, GPIO_25, SAFE_MODE, NC)
	OMAP3_MUX(ETK_D11, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 317 (AG7, L, GPIO_26, EAR_KEY, I[Z], OFF[L])
	OMAP3_MUX(ETK_D12, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP | OMAP3_WAKEUP_EN),
	// 318 (AC5, L, GPIO_27, OMAP_GPIO_3_5_JACK_NINT)
	OMAP3_MUX(ETK_D13, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP3_WAKEUP_EN),
	// 319 (AG8, L, GPIO_28, OMAP_GPIO_LED_EN1_REV04, O[L])
	OMAP3_MUX(ETK_D14,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),
	// 320 (AH8, L, GPIO_29, SAFE_MODE, NC)
	OMAP3_MUX(ETK_D15,	OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN),	// Brian: NC
