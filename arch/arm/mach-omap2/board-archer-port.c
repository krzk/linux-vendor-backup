...
static struct resource archer_power_key_resources[] = {
    [0] = {
	// PWRON KEY
                .start  = 0,
                .end    = 0,
...
static struct platform_device archer_power_key_device = {
        ...
        .id             = -1,
        .num_resources  = ARRAY_SIZE(archer_power_key_resources),
        .resource       = archer_power_key_resources,
};
...
static struct omap_board_mux board_mux[] __initdata = { // WLAN, Alex
        ...
        OMAP3_MUX(GPMC_NCS5,            OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_INPUT_PULLDOWN | OMAP34XX_PIN_OFF_OUTPUT_LOW),
        ...
        OMAP3_MUX(GPMC_WAIT3,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
        ...
        OMAP3_MUX(MCBSP3_DR,            OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW),
        //OMAP3_MUX(MCBSP3_CLKX,          OMAP34XX_MUX_MODE7),
        //OMAP3_MUX(MCBSP3_FSX,           OMAP34XX_MUX_MODE7),

         	// 162 (AF5, L, GPIO_142, TOUCH_INT, I[L], OFF[H])
       OMAP3_MUX(MCBSP3_CLKX, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
	// 163 (AE5, L, GPIO_143, TOUCH_EN, O[L], OFF[H])
	   //OMAP3_MUX(MCBSP3_FSX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_HIGH),
	   OMAP3_MUX(MCBSP3_FSX,  OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_INPUT_PULLDOWN),
        ...
        OMAP3_MUX(MCSPI2_SIMO,          OMAP34XX_MUX_MODE7),
...
{
	archer_power_key_resources[0].start = gpio_to_irq(OMAP_GPIO_KEY_PWRON);
	if (gpio_request(OMAP_GPIO_KEY_PWRON, "power_key_irq") < 0 ) {
		printk(KERN_ERR"\n FAILED TO REQUEST GPIO %d for POWER KEY IRQ \n",OMAP_GPIO_KEY_PWRON);
		return;
	}
	archer_power_key_resources[1].start = gpio_to_irq(OMAP_GPIO_KEY_HOME);
...
*/
	...
	omap_register_i2c_bus(2, 200,NULL, archer_i2c_boardinfo1,
		ARRAY_SIZE(archer_i2c_boardinfo1));
	omap_register_i2c_bus(1, 400,NULL, archer_i2c_boardinfo,
			ARRAY_SIZE(archer_i2c_boardinfo));
