...
#endif /* !USE_DMA_ALLOC */
	unsigned int tmp;
/* 20100823 hongkuk.son for 484386 */
	unsigned int Eint_Wake_Mask = 0x0;
/***/
...
/* 20100823 hongkuk.son for 498658 */
	...
	s3c_pm_set_eint(27, 0x2);   // Fuel_Int
...
/* 20100823 hongkuk.son for 484386 */
	...
	Eint_Wake_Mask = (1 << 8) | (1 << 9) | (1 << 10) | (1 << 12) | (1 << 13) | (1 << 14) | (1 << 16) | (1 << 17) | (1 << 18) | (1 << 19) | (1 << 24) | (1 << 29);
	__raw_writel ( Eint_Wake_Mask, S5P_EINT_WAKEUP_MASK );
/***/
