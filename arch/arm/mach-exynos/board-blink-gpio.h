#ifndef __GPIO_BLINK__
#define __GPIO_BLINK__

#define AP_PD_GPIO_COUNT 121
#define AP_INIT_GPIO_COUNT 19
#define INTERRUPT_SLEEP_GPIO_COUNT 14
#define INTERRUPT_INIT_GPIO_COUNT 9

 unsigned int init_gpio_table[AP_INIT_GPIO_COUNT][3] =
{
...
unsigned int init_gpio_table_alive[INTERRUPT_INIT_GPIO_COUNT][3]=
{
...
unsigned int sleep_gpio_table_alive[INTERRUPT_SLEEP_GPIO_COUNT][3] =
{
...
unsigned int sleep_gpio_table_pd[AP_PD_GPIO_COUNT][3] =
{
