...
int exynos5420_fimc_is_cfg_clk(struct platform_device *pdev)
{
	...
	pr_info("exynos5420_fimc_is_cfg_clk\n");
	...
	pr_info("aclk_400_isp : %ld\n", mcuisp_400);
	mcuisp_400 = clk_get_rate(aclk_mcuisp_div0);
	pr_info("aclk_mcuisp_div0 : %ld\n", mcuisp_400);
	...
	pr_info("sclk_spi0_isp : %ld\n", mcuisp_spi);
	mcuisp_spi = clk_get_rate(sclk_spi0_isp_pre);
	pr_info("sclk_spi0_isp_pre : %ld\n", mcuisp_spi);
	...
	pr_info("sclk_spi1_isp : %ld\n", mcuisp_spi);
	mcuisp_spi = clk_get_rate(sclk_spi1_isp_pre);
	pr_info("sclk_spi1_isp_pre : %ld\n", mcuisp_spi);
	...
	pr_info("exynos5420_fimc_is_cfg_clk ends\n");
	return 0;
}
...
int exynos5420_fimc_is_clk_on(struct platform_device *pdev)
{
	...
	pr_info("exynos5420_fimc_is_clk_on\n");
	...
	pr_info("exynos5420_fimc_is_clk_on ends\n");
	return 0;
}
