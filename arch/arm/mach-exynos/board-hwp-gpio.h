...
unsigned int init_gpio_table[][3] =
{
	...
	{ EXYNOS3_GPD0(2), S3C_GPIO_INPUT, S3C_GPIO_PULL_NONE},					/* MUIC_I2C_SDA */
	{ EXYNOS3_GPD0(3), S3C_GPIO_INPUT, S3C_GPIO_PULL_NONE },				/* MUIC_I2C_SCL*/
	...
	{ EXYNOS3_GPE1(4), S3C_GPIO_INPUT, S3C_GPIO_PULL_DOWN },				/* MOTOR_EN */
	#if 0 /* it's occured to kernel panic */
	{ EXYNOS3_GPK0(0), S3C_GPIO_INPUT, S3C_GPIO_PULL_DOWN },				/* TP*/
	#endif

	{ EXYNOS3_GPK1(0), S3C_GPIO_INPUT, S3C_GPIO_PULL_DOWN },   				/* WLAN_SDIO_CLK */
...
unsigned int init_gpio_table_alive[][3]=
{
	...
	{EXYNOS3_GPX3(7), S3C_GPIO_INPUT, S3C_GPIO_PULL_DOWN},					/* WPC_INT */
};

unsigned int sleep_gpio_table_alive[][3] =
{
	{EXYNOS3_GPX1(0), S3C_GPIO_INPUT, S3C_GPIO_PULL_DOWN},					/* ERR_FG */
	{EXYNOS3_GPX0(1), S3C_GPIO_INPUT, S3C_GPIO_PULL_DOWN},					/* NC */

	{EXYNOS3_GPX1(3), S3C_GPIO_INPUT, S3C_GPIO_PULL_DOWN},				/* OFM_MOTION */
	{EXYNOS3_GPX1(4), S3C_GPIO_SFN(0xf), S3C_GPIO_PULL_UP},					/* CODEC_IRQ */
	{EXYNOS3_GPX1(5), S3C_GPIO_SFN(0xf), S3C_GPIO_PULL_NONE},				/* CHG_INTB */
...
//	{ EXYNOS3_GPB(3), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },			/* SHUB_SPI_MOSI */
	...
	//GPE0(6)										/* OFM_PWRDOWN */
	{ EXYNOS3_GPE0(7), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },        		/* NFC_EN */

	{ EXYNOS3_GPE1(0), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },       			/* NFC_FIRMWARE */
	{ EXYNOS3_GPE1(1), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE },        	/* WRSTBI */
	{ EXYNOS3_GPE1(2), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },       			/* FUEL_I2C_SDA */
	{ EXYNOS3_GPE1(3), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },     			/* FUEL_I2C_SCL */
#if 0
	...
	{ EXYNOS3_GPK1(0), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },   			/* WLAN_SDIO_CLK */
