...
#define GPIO_IF_PMIC_SDA1	EXYNOS3_GPX2(2)
#define GPIO_IF_PMIC_SCL1	EXYNOS3_GPX2(3)
...
static struct i2c_gpio_platform_data gpio_i2c_if_pmic1 = {
	.sda_pin = GPIO_IF_PMIC_SDA1,
	.scl_pin = GPIO_IF_PMIC_SCL1,
};

static struct platform_device device_i2c_if_pmic1 = {
	.name = "i2c-gpio",
	.id = I2C_IF_PMIC_ID,
	.dev.platform_data = &gpio_i2c_if_pmic1,
};
...
void __init exynos3_b2_mfd_init(void)
{
	...
	platform_device_register(&device_i2c_if_pmic);
		...
		s3c_gpio_cfgpin(GPIO_IF_PMIC_SDA1, S3C_GPIO_INPUT);
		s3c_gpio_cfgpin(GPIO_IF_PMIC_SCL1, S3C_GPIO_INPUT);

		s3c_gpio_setpull(GPIO_IF_PMIC_SDA1, S3C_GPIO_PULL_NONE);
		s3c_gpio_setpull(GPIO_IF_PMIC_SCL1, S3C_GPIO_PULL_NONE);

		i2c_register_board_info(I2C_IF_PMIC_ID,
			i2c_devs_if_pmic, ARRAY_SIZE(i2c_devs_if_pmic));

		platform_device_register(&device_i2c_if_pmic1);
	}
#endif
