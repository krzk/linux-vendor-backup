...
#include "board-tizen-wlan.h"

#define GPIO_LEVEL_LOW		0
#define GPIO_LEVEL_HIGH		1
#define GPIO_LEVEL_NONE		2

#define GPIO_WLAN_SDIO_CLK      EXYNOS3_GPK1(0)
#define GPIO_WLAN_SDIO_CLK_AF   2
#define GPIO_WLAN_SDIO_CMD      EXYNOS3_GPK1(1)
#define GPIO_WLAN_SDIO_CMD_AF   2
#define GPIO_WLAN_SDIO_D0       EXYNOS3_GPK1(3)
#define GPIO_WLAN_SDIO_D0_AF    2
#define GPIO_WLAN_SDIO_D1       EXYNOS3_GPK1(4)
#define GPIO_WLAN_SDIO_D1_AF    2
#define GPIO_WLAN_SDIO_D2       EXYNOS3_GPK1(5)
#define GPIO_WLAN_SDIO_D2_AF    2
#define GPIO_WLAN_SDIO_D3       EXYNOS3_GPK1(6)
#define GPIO_WLAN_SDIO_D3_AF    2
#define GPIO_WLAN_EN            EXYNOS3_GPE0(4)
#define GPIO_WLAN_EN_AF         1
#define GPIO_WLAN_HOST_WAKE     EXYNOS3_GPX1(1)
//#define GPIO_WLAN_HOST_WAKE_AF  0xF
#define GPIO_WLAN_HOST_WAKE_AF  0x2
...
static int brcm_wlan_power(int onoff)
{
	printk(KERN_ERR"------------------------------------------------");
	printk(KERN_ERR"------------------------------------------------\n");
	printk(KERN_ERR"%s Enter: power %s\n", __func__, onoff ? "on" : "off");
