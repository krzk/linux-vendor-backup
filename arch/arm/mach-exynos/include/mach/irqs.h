...
#else /* CONFIG_SOC_EXYNOS5260 */
#define S5P_EINT_BASE1			COMBINER_IRQ(MAX_COMBINER_NR, 0)
#endif /* CONFIG_SOC_EXYNOS5260 */
#define S5P_EINT_BASE2			(S5P_EINT_BASE1 + 16)
...
#if defined(CONFIG_MFD_CS47L24) || defined(CONFIG_MFD_LARGO)
#define IRQ_BOARD_CODEC_NR		77
#else
