...
extern struct clksrc_clk exynos5420_clk_sclk_mau_pcm0;
extern struct clksrc_clk exynos5420_mau_epll_clk;
...
struct clksrc_clk exynos_clk_dout_audss_bus = {
	.clk	= {
		.name		= "dout_bus",
...
static struct clk exynos_init_audss_clocks[] = {
	{
		...
		.parent		= &exynos5420_clk_sclk_mau_pcm0.clk,
		.enable		= exynos_clk_audss_ctrl,
