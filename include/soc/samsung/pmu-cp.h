...
#define EXYNOS_PMU_UART_IO_SHARE_CTRL		0x0760
#define EXYNOS_PMU_USBDEV_PHY_CONTROL		0x0704

/* EXYNOS_PMU_UART_IO_SHARE_CTRL */
#define SEL_TXD_USB_PHY_POS		28
#define SEL_TXD_USB_PHY_MASK		(0x3 << SEL_TXD_USB_PHY_POS)
#define SEL_TXD_GPIO_0_POS		24
#define SEL_TXD_GPIO_0_MASK		(0x3 << SEL_TXD_GPIO_0_POS)
#define SEL_TXD_GPIO_1_POS		20
#define SEL_TXD_GPIO_1_MASK		(0x3 << SEL_TXD_GPIO_1_POS)
#define SEL_RXD_AP_UART_POS		16
#define SEL_RXD_AP_UART_MASK		(0x3 << SEL_RXD_AP_UART_POS)
#define SEL_RXD_CP_UART_POS		12
#define SEL_RXD_CP_UART_MASK		(0x3 << SEL_RXD_CP_UART_POS)
#define FUNC_ISO_EN_POS			0
#define FUNC_ISO_EN_MASK		BIT(FUNC_ISO_EN_POS)

/* EXYNOS_PMU_USBDEV_PHY_CONTROL */
#define ENABLE_USB20_POS		1
#define ENABLE_USB20_MASK		BIT(ENABLE_USB20_POS)
