...
#if IS_ENABLED(CONFIG_DEVFREQ_GOV_SIMPLE_ONDEMAND) || IS_ENABLED(CONFIG_DEVFREQ_GOV_SIMPLE_USAGE) || IS_ENABLED(CONFIG_DEVFREQ_GOV_EXYNOS_BUS)
...
#ifdef CONFIG_DEVFREQ_GOV_EXYNOS_BUS
extern const struct devfreq_governor devfreq_exynos_bus;

struct devfreq_exynos_bus_data {
	unsigned int multiplication_weight;
	unsigned int upthreshold;
	unsigned int downdifferential;
	unsigned long cal_qos_max;
