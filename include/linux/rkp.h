...
#else
#define RKP_PHYS_MAP_START	(0xA0000000)
#define RKP_PHYS_MAP_SIZE	(2ULL << 20)
#define RKP_PGT_BITMAP_LEN	0x20000
#endif

#define RKP_ROBUF_START		0xA0380000
#define RKP_ROBUF_SIZE	         (0x400000ULL)

#define RKP_EXTRA_MEM_START	(RKP_ROBUF_START + RKP_ROBUF_SIZE)
#define RKP_EXTRA_MEM_SIZE	   0x300000
...
#else
#define PHYS_PFN_OFFSET_MAX 0xaffffULL
static inline u64 rkp_get_sys_index(u64 pfn)
{
	if (pfn >= PHYS_PFN_OFFSET && pfn < PHYS_PFN_OFFSET_MAX)
      		return  ((pfn) - PHYS_PFN_OFFSET);
	return (~0ULL);
}
#endif
