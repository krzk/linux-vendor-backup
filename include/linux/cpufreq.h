...
#endif /* CONFIG_CPU_FREQ_STAT_TIZEN */
...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_TIZEN_MORION)
extern struct cpufreq_governor cpufreq_gov_tizen_morion;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_tizen_morion)
