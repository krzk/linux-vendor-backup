...
extern int get_last_irq_history(struct irq_history *last);
#else
static inline int get_last_irq_history(struct irq_history *last) { return 0;}
#endif
