...
static int serial_omap_startup(struct uart_port *port)
{
	...
	{
		sec_get_param_value(__PARAM_INT_14, &param_int_14);
	}	
	...
	*/
	...
	dev_dbg(up->port.dev, "serial_omap_startup+ param_int_14 = %d\n", param_int_14);		
		...
		unsigned int count)
{
	...
	omap_writel((omap_readl(0x48005030) & ~0x800), 0x48005030); //TI -  Lewis Byun: 2010-12-09 --> to prevent a corner case
	omap_writel((omap_readl(0x48005010) | 0x800), 0x48005010); //TI -  Lewis Byun: 2010-12-09--> to prevent a corner case
	omap_writel((omap_readl(0x48005000) | 0x800), 0x48005000); //TI -  Lewis Byun: 2010-12-09--> to prevent a corner case
...
/* This function would check if the UART is being used+ * as a console or not */
