...
void scsc_bt_shm_exit(void)
{
	...
	if (bt_service.bsmhcp_protocol != NULL) {
		...
		scsc_service_mifintrbit_bit_clear(bt_service.service, bt_service.bsmhcp_protocol->header.ap_to_fg_int_src);
		scsc_service_mifintrbit_bit_clear(bt_service.service, bt_service.bsmhcp_protocol->header.ap_to_bg_int_src);

		scsc_service_mifintrbit_bit_unmask(bt_service.service, bt_service.bsmhcp_protocol->header.ap_to_fg_int_src);
		scsc_service_mifintrbit_bit_unmask(bt_service.service, bt_service.bsmhcp_protocol->header.ap_to_bg_int_src);
