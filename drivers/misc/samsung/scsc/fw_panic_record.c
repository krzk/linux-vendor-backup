...
static void fw_parse_r4_panic_record_v2(u32 *r4_panic_record)
{
...
void fw_parse_r4_panic_record(u32 *r4_panic_record)
{
	...
	default:
		SCSC_TAG_ERR(FW_PANIC, "BAD panic_record_version: %d\n",
			     panic_record_version);
		return;
	case PANIC_RECORD_R4_VERSION_1:
		fw_parse_r4_panic_record_v1(r4_panic_record);
		break;
	case R4_PANIC_RECORD_VERSION_2:
		fw_parse_r4_panic_record_v2(r4_panic_record);
		break;
	}
}
