/* drivers/video/fbdev/exynos/dpu_9110/panels/s6e36w2x01_dimming.c
 *
...
int s6e36w2x01_generate_volt_table(struct dim_data *data)
{
	int i, j;
	int seq, index, gray;
	int ret = 0;
...
int s6e36w2x01_cal_gamma_from_index(struct dim_data *data, struct SmtDimInfo *brInfo)
{
	int i, j;
	int ret = 0;
	int gray, index;
