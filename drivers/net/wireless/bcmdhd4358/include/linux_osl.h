...
#define	DMA_ALLOC_CONSISTENT_FOR_RING_CREATE(osh, size, align, tot, pap, dmah) \
	osl_dma_alloc_consistent_for_ring_create((osh), (size), (align), (tot), (pap))
extern void *osl_dma_alloc_consistent_for_ring_create(osl_t *osh, uint size, uint16 align,
	uint *tot, dmaaddr_t *pap);
extern void osl_dma_free_consistent_for_ring_create(osl_t *osh, void *va, uint size, dmaaddr_t pa);
#endif /* CONFIG_64BIT */
#endif /* BCMPCIE */
