/*
 * drivers/input/misc/sec_auto_input.c
 *
...
static int tsp_input_register(struct auto_input_data *data) {
	...
	input_set_abs_params(data->input_dev,
			 ABS_MT_POSITION_X, 0,data->max_x - 1, 0, 0);
	input_set_abs_params(data->input_dev,
			ABS_MT_POSITION_Y, 0, data->max_y - 1, 0, 0);
	input_set_abs_params(data->input_dev,
			ABS_X, 0, data->max_x - 1, 0, 0);
	input_set_abs_params(data->input_dev,
			ABS_Y, 0, data->max_y - 1, 0, 0);
	...
	input_set_abs_params(data->input_dev,
			ABS_MT_TRACKING_ID, 0, FINGER_NUM, 0, 0);
	input_set_abs_params(data->input_dev,
			ABS_MT_ORIENTATION, -128, 127, 0, 0);
	input_set_abs_params(data->input_dev,
			ABS_MT_TOOL_TYPE, 0, MT_TOOL_MAX, 0, 0);
	input_set_abs_params(data->input_dev,
			ABS_MT_PRESSURE, 0, DEFAULT_MAX_Z, 0, 0);
	input_set_abs_params(data->input_dev,
			ABS_MT_PALM, 0, 1, 0, 0);
...
static int __init auto_input_init(void)
{
	...
	data->dev = sec_device_create(NULL, DEVICE_NAME);
	if (IS_ERR(data->dev)) {
