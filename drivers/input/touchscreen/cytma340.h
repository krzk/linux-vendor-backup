/* drivers/input/touchscreen/cytma340.h
 *
 * TMA340 TSP driver.
 *
...
#define  UPDATE_TMA340_FLASH          0

#define TMA340_I2C_ADDR       0x20//0x4A
#define TMA340_I2C_BOOT_ADDR  0x24
...
#define DEBUG_MSG(p, x...)			printk("[TMA340]:[%s] ", __func__); printk(p, ## x);		
#define ENTER_FUNC	{ printk("[TMA340] +%s\n", __func__); }
#define LEAVE_FUNC	{ printk("[TMA340] -%s\n", __func__); }
...
#define PRINT_MSG(p, x...)		{ printk("[TMA340]:[%s] ", __func__); printk(p, ## x); }
#else
#define print_msg()
#define dprintk(...) 
...
int cytma340_i2c_read(u16 reg,unsigned char *rbuf, int buf_size);
...
/* Module information */
MODULE_DESCRIPTION("TMA340 Touchscreen driver");
MODULE_LICENSE("GPL");
