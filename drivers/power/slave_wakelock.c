		...
		struct slave_wakelock *slwl, unsigned int idx)
{
	...
	ret = seq_printf(m, "%3d\t%-12s\t%u\t\t%12lld\t%14lld\t\t%10lld\t%12lld\t%15lld\t%21lld\n",
...
static int slave_wakelock_show(struct seq_file *m, void *unused)
{
	...
	seq_puts(m, "idx\tname\t\tpid\t\tactive_since\tlast_prev_time\t\ttotal_time\t"
				"slp_mon_time\tenergy_mon_time\tenergy_mon_check_time\n");
