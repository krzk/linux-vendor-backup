...
enum sec_gsim_ext_boot_type {
	...
	SEC_GSIM_EXT_BOOT_TYPE_RESERVED_3,
	SEC_GSIM_EXT_BOOT_TYPE_RESERVED_4,
	SEC_GSIM_EXT_BOOT_TYPE_RESERVED_5,
	SEC_GSIM_EXT_BOOT_TYPE_RESERVED_6,
...
static const char *sec_gsim_ext_boot_type_property[SEC_GSIM_EXT_BOOT_TYPE_MAX] = {
	[SEC_GSIM_EXT_BOOT_TYPE_KERNEL_PANIC] = "ext-boot,kernel-panic",
	[SEC_GSIM_EXT_BOOT_TYPE_CP_CRASH]     = "ext-boot,cp-crash",
	[SEC_GSIM_EXT_BOOT_TYPE_SECURE_FAIL]  = "ext-boot,secure-fail",
};
