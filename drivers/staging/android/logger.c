...
static int __init create_log(char *log_name, int size)
{
	...
	log->misc.mode = (S_IRUGO|S_IWUGO);
#ifdef CONFIG_SECURITY_SMACK_SET_DEV_SMK_LABEL
	log->misc.lab_smk64 = LOGGER_SMACK_LABEL;
#endif
...
#define LOGGER_LOG_MAIN_SIZE	(2048*1024)
#define LOGGER_LOG_RADIO_SIZE	(512*1024)
#define LOGGER_LOG_SYSTEM_SIZE	(1024*1024)
