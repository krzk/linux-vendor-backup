...
static struct device_attribute attributes[] = {
	__ATTR(chub_save_log, 0664, chub_log_save_show, chub_log_save_save),
	__ATTR(chub_flush_log, 0664, chub_log_flush_show, chub_log_flush_save),
	__ATTR(chub_dump_log, 0220, NULL, chub_dump_log_save)
};
