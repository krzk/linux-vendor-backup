...
/* MIF 200Mhz use same voltage from under 200Mhz */
#define MIF_EASY_200MHZ

#define MIF_200MHZ					(200000)
#define MIF_EASY_200MHZ_USAGE		(10)
#define MIF_EASY_200MHZ_REFER_FREQ	(100000)
...
#if defined(MIF_EASY_200MHZ)
	if ((mif_data->mif_usage * devfreq_mif->previous_freq)
			>= (MIF_EASY_200MHZ_USAGE * MIF_EASY_200MHZ_REFER_FREQ))
		*target_freq = max((unsigned long)MIF_200MHZ, *target_freq);
#endif
