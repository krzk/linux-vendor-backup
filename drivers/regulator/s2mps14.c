...
static char* reg_description[S2MPS14_REG_LDO_DSCH3 + 1] = {
	"ID reg  ", "INT1 reg", "INT2 reg", "INT3 reg", "INPUT1 M", "INPUT2 M", "INPUT3 M",
	"STAT1   ", "STAT2   ", "PWRONSRC", "OFFSRC  ", "B/U CHG ", "RTC BUF ", "CTRL1   ",
	"CTRL2   ", "Reserved", "Reserved", "Reserved", "Reserved", "Reserved", "Reserved",
	"CTRL3   ", "Reserved", "Reserved", "Reserved", "BUCK1CTL", "BUCK1OUT", "BUCK2CTL",
	"BUCK2OUT", "BUCK3CTL", "BUCK3OUT", "BUCK4CTL", "BUCK4OUT", "BUCK5CTL", "BUCK5OUT",
	"LDO1 CTL", "LDO2 CTL", "LDO3 CTL", "LDO4 CTL", "LDO5 CTL", "LDO6 CTL", "LDO7 CTL",
	"LDO8 CTL", "LDO9 CTL", "LDO10CTL", "LDO11CTL", "LDO12CTL", "LDO13CTL", "LDO14CTL",
	"LDO15CTL", "LDO16CTL", "LDO17CTL", "LDO18CTL", "LDO19CTL", "LDO20CTL", "LDO21CTL",
	"LDO22CTL", "LDO23CTL", "LDO24CTL", "LDO25CTL", "LDO_DSC1", "LDO_DSC2", "LDO_DSC3",
};
