...
#define ROTARY_BOOSTER_DELAY        150
static int rotary_min_cpu_freq = 839000;
#endif

#if defined(BACK_KEY_BOOSTER)
static int back_key_min_cpu_freq = 839000;
#define BACK_KEY_BOOSTER_DELAY      150
#endif
...
#define TOUCH_BOOSTER_CHG_TIME      150
