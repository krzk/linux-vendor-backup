...
struct cpu_test_list_tag cpu_freqtest_list[] = {
	{CPU_FREQ_TEST, CPUFREQ_1040M, 1000},
	{CPU_FREQ_TEST, CPUFREQ_962M, 1000},
	{CPU_FREQ_TEST, CPUFREQ_829M, 1000},
	{CPU_FREQ_TEST, CPUFREQ_757M, 1000},
	{CPU_FREQ_TEST, CPUFREQ_676M, 1000},
	{CPU_FREQ_TEST, CPUFREQ_546M, 1000},
...
void set_cpufreq_force_state(int cpufreq_enum)
{
	switch(cpufreq_enum) {
		case CPUFREQ_1040M:
			cpufreq_force_state = 1040000;
			break;
		case CPUFREQ_962M:
			cpufreq_force_state = 962000;
			break;
		case CPUFREQ_829M:
			cpufreq_force_state = 829000;
			break;
		case CPUFREQ_757M:
...
int cpu_freq_to_enum(int cpufreq)
{
	...
	switch (cpufreq) {
		case 1040000:
			cpufreq_enum = CPUFREQ_1040M;
			break;
		case 962000:
			cpufreq_enum = CPUFREQ_962M;
			break;
		case 829000:
			cpufreq_enum = CPUFREQ_829M;
			break;
		case 757000:
			cpufreq_enum = CPUFREQ_757M;
			break;
		case 676000:
			cpufreq_enum = CPUFREQ_676M;
			break;
		case 546000:
			cpufreq_enum = CPUFREQ_546M;
			break;
	}
