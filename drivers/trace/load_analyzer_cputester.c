		...
		const char __user *user_buf, size_t count, loff_t *ppos)
{
	...
	cpufreq_input = cpu_tester_check_onoff((char *)buf, "cpufreq:");
	cpuidle_input = cpu_tester_check_onoff((char *)buf, "cpuidle:");
	cpuload_input = cpu_tester_check_onoff((char *)buf, "cpuload:");
	all_input = cpu_tester_check_onoff((char *)buf, "all:");
