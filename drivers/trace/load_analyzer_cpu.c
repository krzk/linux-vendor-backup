...
int get_meminfo_proc(char *buf, int buf_size, int ret)
{
...
#if defined(CONFIG_SLP_KERNEL_ENG) || defined (CONFIG_TIZEN_SEC_KERNEL_ENG)
	ret +=  snprintf(buf + ret, buf_size - ret, "Active:\t\t%lu\n", (pages[LRU_ACTIVE_ANON] +
						pages[LRU_ACTIVE_FILE]) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Inactive:\t%lu\n", (pages[LRU_INACTIVE_ANON] +
						pages[LRU_INACTIVE_FILE]) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Active(anon):\t%lu\n", pages[LRU_ACTIVE_ANON] << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Inactive(anon):\t%lu\n", pages[LRU_INACTIVE_ANON] << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Active(file):\t%lu\n", pages[LRU_ACTIVE_FILE] << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Inactive(file):\t%lu\n", pages[LRU_INACTIVE_FILE] << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Unevictable:\t%lu\n", pages[LRU_UNEVICTABLE] << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Mlocked:\t%lu\n",
						global_page_state(NR_MLOCK) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "SwapTotal:\t%lu\n", i.totalswap << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "SwapFree:\t%lu\n", i.freeswap << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Dirty:\t\t%lu\n",
						global_node_page_state(NR_FILE_DIRTY) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Writeback:\t%lu\n",
						global_node_page_state(NR_WRITEBACK) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "AnonPages:\t%lu\n",
						global_node_page_state(NR_ANON_MAPPED) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Mapped:\t\t%lu\n",
						global_node_page_state(NR_FILE_MAPPED) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Shmem:\t\t%lu\n", i.sharedram << (PAGE_SHIFT - 10));
#endif
	...
	ret +=  snprintf(buf + ret, buf_size - ret, "SUnreclaim:\t%lu\n",
						global_page_state(NR_SLAB_UNRECLAIMABLE) << (PAGE_SHIFT - 10));
#if defined(CONFIG_SLP_KERNEL_ENG) || defined (CONFIG_TIZEN_SEC_KERNEL_ENG)
	ret +=  snprintf(buf + ret, buf_size - ret, "KernelStack:\t%lu\n",
						global_page_state(NR_KERNEL_STACK_KB));
	ret +=  snprintf(buf + ret, buf_size - ret, "PageTables:\t%lu\n",
						global_page_state(NR_PAGETABLE) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "NFS_Unstable:\t%lu\n",
						global_node_page_state(NR_UNSTABLE_NFS) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "Bounce:\t\t%lu\n",
						global_page_state(NR_BOUNCE) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "WritebackTmp:\t%lu\n",
						global_node_page_state(NR_WRITEBACK_TEMP) << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "CommitLimit:\t%lu\n", vm_commit_limit() << (PAGE_SHIFT - 10));
	ret +=  snprintf(buf + ret, buf_size - ret, "VmallocTotal:\t%lu\n", (unsigned long)VMALLOC_TOTAL >> 10);
	ret +=  snprintf(buf + ret, buf_size - ret, "CmaFree:\t%lu\n",
