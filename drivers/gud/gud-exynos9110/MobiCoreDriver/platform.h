...
#if defined(CONFIG_SOC_EXYNOS3250) || defined(CONFIG_SOC_EXYNOS9110)
...
#if defined(CONFIG_SOC_EXYNOS3250) || defined(CONFIG_SOC_EXYNOS3475) || defined(CONFIG_SOC_EXYNOS9110)
...
#define DEFAULT_BIG_CORE		1
#define MIGRATE_TARGET_CORE     DEFAULT_BIG_CORE

#define MC_INTR_LOCAL_TIMER            (IRQ_SPI(237) + DEFAULT_BIG_CORE)
