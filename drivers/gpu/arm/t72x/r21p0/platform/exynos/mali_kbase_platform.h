...
typedef enum {
	EXCEPTION_JOB_CONFIG_FAULT,
	EXCEPTION_JOB_POWER_FAULT,
	EXCEPTION_JOB_READ_FAULT,
	EXCEPTION_JOB_WRITE_FAULT,
	EXCEPTION_JOB_AFFINITY_FAULT,
	EXCEPTION_JOB_BUS_FAULT,
	EXCEPTION_DATA_INVALIDATE_FAULT,
	EXCEPTION_TILE_RANGE_FAULT,
	EXCEPTION_OUT_OF_MEMORY_FAULT,
	EXCEPTION_DELAYED_BUS_FAULT,
	EXCEPTION_SHAREABILITY_FAULT,
	EXCEPTION_MMU_TRANSLATION_FAULT,
	EXCEPTION_MMU_PERMISSION_FAULT,
	EXCEPTION_MMU_TRANSTAB_BUS_FAULT,
	EXCEPTION_MMU_ACCESS_FLAG_FAULT,
	EXCEPTION_MMU_ADDRESS_SIZE_FAULT,
	EXCEPTION_MMU_MEMORY_ATTRIBUTES_FAULT,
	EXCEPTION_UNKNOWN,
	EXCEPTION_SOFT_STOP,
	EXCEPTION_HARD_STOP,
	EXCEPTION_RESET,
...
#ifdef CONFIG_MALI_TIZEN_DQA
	int exception_count[EXCEPTION_END];
#else
	int reset_count;
