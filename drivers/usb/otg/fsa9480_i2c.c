...
#ifdef CONFIG_USB_ANDROID_SAMSUNG_MENU_SEL
					       /*inform USB menu cable is connected*/
					       Send_USB_status_to_UsbMenuSel(1);
#endif
...
#ifdef CONFIG_USB_ANDROID_SAMSUNG_MENU_SEL
						    /*inform USB menu cable is detached*/
						    Send_USB_status_to_UsbMenuSel(0);
#endif
...
#ifdef CONFIG_FSA9480_GPIO_I2C
/* Start. Heekwon Ko 20101206: Remap USB Control GPIO for heron */
/* SDA : GPIO_158, SCL : GPIO_161*/
#if defined(CONFIG_CHN_HERON_FSA9480)
fsa9480_i2c_client  = omap_gpio_i2c_init(OMAP_GPIO_USBSW_I2C_SDA,
						  OMAP_GPIO_USBSW_I2C_SCL,
						  0x25,
						  200);
#else						  
fsa9480_i2c_client  = omap_gpio_i2c_init(OMAP_GPIO_AP_I2C_SDA,
						  ...
						  200);
#endif
/* End. Heekwon Ko 20101206: Remap USB Control GPIO for heron */
