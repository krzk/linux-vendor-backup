...
#define CONFIG_MAX14577_MICROUSB_CURRENT_CHANGE
...
enum {
    CHARGING_CURRENT_600,
    CHARGING_CURRENT_450,
    CHARGING_CURRENT_400,
};

#define CURRENT_CHANGE_TEMPERATURE		41
#endif
...
#define CHARGE_STOP_TEMPERATURE_MIN     	0
#define CHARGE_RECOVER_TEMPERATURE_MIN      2

#define CHARGE_STOP_TEMPERATURE_MAX_OFFMODE     	65		
#define CHARGE_RECOVER_TEMPERATURE_MAX_OFFMODE      43		

#define CHARGE_STOP_TEMPERATURE_MIN_OFFMODE     	-1
#define CHARGE_RECOVER_TEMPERATURE_MIN_OFFMODE      1

#define CHARGE_RECHG_VOLTAGE            	4200
#define CHARGE_RECHG_VOLTAGE_OFFMODE       	4200

#define CHARGE_STOP_TEMPERATURE_EVENT		65
#define CHARGE_RECOVER_TEMPERATURE_EVENT    48
#else
#define DEFAULT_CHARGING_TIMEOUT        6 * 60 * 60
#define DEFAULT_RECHARGING_TIMEOUT        (1 * 60 * 60 + 30 * 60)
