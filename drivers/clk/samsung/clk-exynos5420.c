...
static const struct samsung_mux_clock exynos5800_mux_clks[] __initconst = {
	...
	MUX(CLK_MOUT_WCORE, "mout_aclk400_wcore", mout_group2_5800_p,
			SRC_TOP0, 16, 3),
...
static const struct samsung_gate_clock exynos5x_gate_clks[] __initconst = {
	...
	GATE(CLK_CLKM_PHY0, "clkm_phy0", "dout_sclk_cdrex", GATE_BUS_CDREX0, 0, 0, 0),
	GATE(CLK_CLKM_PHY1, "clkm_phy1", "dout_sclk_cdrex", GATE_BUS_CDREX0, 1, 0, 0),
...
static const struct samsung_pll_rate_table exynos5422_bpll_rate_table[] __initconst = {
	PLL_35XX_RATE(933000000, 311, 4, 1),
	PLL_35XX_RATE(925000000, 307, 4, 1),
	PLL_35XX_RATE(825000000, 275, 4, 1),
	PLL_35XX_RATE(728000000, 182, 3, 1),
	PLL_35XX_RATE(633000000, 211, 4, 1),
	PLL_35XX_RATE(543000000, 181, 2, 2),
	PLL_35XX_RATE(413000000, 413, 6, 2),
	PLL_35XX_RATE(275000000, 275, 3, 3),
	PLL_35XX_RATE(206000000, 206, 3, 3),
	PLL_35XX_RATE(165000000, 110, 2, 3),
	PLL_35XX_RATE(138000000, 184, 2, 4),
};
