		...
		unsigned pin)
{
	...
	/* GPB & GPV ports are AUD interface (I2S, UART, PCM, SB) that should not
...
struct gpio_dvs_t exynos9110_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.get_nr_gpio = exynos9110_secgpio_get_nr_gpio,
};
#endif
