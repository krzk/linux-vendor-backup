...
#define MFC_FW_NAME		"mfc/e9110/mfc_fw.bin"
 ...
 * Version Description
 */
#define IS_MFCV1021(dev)	(s5p_mfc_version(dev) == 0x1021)
...
#define FROM_MFCV10X(dev)	(IS_MFCV1021(dev) || IS_MFCV11X(dev) || \
				IS_MFCV12X(dev))
...
#define FW_SUPPORT_SKYPE(dev)		(FROM_MFCV11X(dev) &&		\
					(dev->fw.date >= 0x150901))
#define FW_HAS_VIDEO_SIGNAL_TYPE(dev)	(FROM_MFCV11X(dev) &&		\
					(dev->fw.date >= 0x151223))
#define FW_HAS_SEI_INFO_FOR_HDR(dev)	(FROM_MFCV11X(dev) &&		\
