...
struct fimc_is_pdp_interface_ops {
	...
	int (*reserved1)(struct fimc_is_sensor_interface *itf, struct pdp_total_setting_t *pdp_param);
	int (*reserved2)(struct fimc_is_sensor_interface *itf, struct pdp_total_setting_t *pdp_param);
	int (*reserved3)(struct fimc_is_sensor_interface *itf, struct pdp_total_setting_t *pdp_param);
	int (*reserved4)(struct fimc_is_sensor_interface *itf, struct pdp_total_setting_t *pdp_param);
	int (*reserved5)(struct fimc_is_sensor_interface *itf, struct pdp_total_setting_t *pdp_param);
	int (*reserved6)(struct fimc_is_sensor_interface *itf, struct pdp_total_setting_t *pdp_param);
};
...
struct fimc_is_csi_interface_ops {
	int (*get_vc_dma_buf)(struct fimc_is_sensor_interface *itf,
				...
				enum itf_vc_buf_data_type *return_data_type,
				u32 *buf_index,
				u64 *buf_addr,
				u32 *frame_count);
