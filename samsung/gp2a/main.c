...
static void GPIO_setting( void )
{
	...
	gpio53_pad_config_reg = ( void __iomem * )IO_ADDRESS( 0x480020B0 );  // 0x480020B0 : gpio_53
...
#if 0 //defined(CONFIG_MACH_SAMSUNG_LATONA) && CONFIG_SAMSUNG_REL_HW_REV >= 1
...
#if defined(CONFIG_MACH_SAMSUNG_HERON)
	this_client = omap_gpio_i2c_init(OMAP_GPIO_SENSOR_SDA, OMAP_GPIO_SENSOR_SCL, 0x44, 200);
#else
