...
static int bma222_fast_calibration(char layout[])
{
    ...
    yas_bma222_update_bits(BMA222_COMP_TARGET_OFFSET_X, layout[0]);

    yas_bma222_update_bits(BMA222_EN_FAST_COMP, tmp);
    do
    {
        mdelay(2);
        tmp = yas_bma222_read_bits(BMA222_FAST_COMP_RDY_S);
    } while(tmp == 0);

    yas_bma222_update_bits(BMA222_COMP_TARGET_OFFSET_Y, layout[1]);
   ...
   yas_bma222_update_bits(BMA222_EN_FAST_COMP, tmp);
    ...
    yas_bma222_update_bits(BMA222_COMP_TARGET_OFFSET_Z, layout[2]);
    ...
    tmp = 1;	//unlock eeprom
    yas_bma222_update_bits(BMA222_UNLOCK_EE_WRITE_SETTING, tmp);
    yas_bma222_update_bits(BMA222_START_EE_WRITE_SETTING, 0x01);

    do
    {
        mdelay(2); 
        tmp = yas_bma222_read_bits(BMA222_EE_WRITE_SETTING_S);
    } while(tmp==0);
